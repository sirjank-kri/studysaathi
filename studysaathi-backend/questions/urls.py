...
urlpatterns = [
    ...
    # ── AI Endpoints ──────────────────────────────────
    path('questions/<int:question_id>/ai-answer/', ai_views.generate_ai_answer, name='generate-ai-answer'),
    path('questions/<int:question_id>/ai-answer/regenerate/', ai_views.regenerate_ai_answer, name='regenerate-ai-answer'),
]